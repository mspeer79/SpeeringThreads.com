...
<asp:Content ID="Content2" ContentPlaceHolderID="MainContent" runat="server">
    ...
    <!-- Threadlines -->
        <h1><img src="~/images/4thImage.gif" width="862" height="371" alt="MainImage1" runat="server"/></h1>
        
        <table width="862" border="0">
          <tr>
            <th width="280" align="center" scope="col"><a href="ThreadsFuture">Threads of the Future</th>
            <!--th width="280" align="center" scope="col"><a href="SocialThreads.aspx">Social Threads</th> -->
            <th width="280" align="center" scope="col"><a href="PromotionalThreads">Promotional Threads</th>
          </tr>
          <tr>
